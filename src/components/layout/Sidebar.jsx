      ...
      >
        ...
        {parkingDetails && !isLoading && !error && (
            <div className="mt-6 space-y-5">
              ...
              {parkingDetails.rate && (
                  <div
                      className="flex justify-center items-center p-3 bg-slate-100 dark:bg-slate-700/50 rounded-lg shadow-sm mt-2">
                  <span className="font-semibold text-slate-800 dark:text-slate-100 text-center w-full">
                    Precio: {parkingDetails.rate}
                  </span>
                  </div>
              )}
