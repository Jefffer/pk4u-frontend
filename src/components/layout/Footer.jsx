      ...
      <footer className="bg-white dark:bg-slate-950 text-slate-800 dark:text-white border-t-1 border-teal-800 shadow-md py-8 px-4 mt-auto">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          <div className="text-center md:text-left">
            <h5 className="text-xl font-bold mb-2">{t('footer.projectInfo.title')}</h5>
            <p className="text-sm text-gray-400">{t('footer.projectInfo.description')}</p>
          </div>

          <div className="text-center">
            <h5 className="text-lg font-semibold mb-2">{t('footer.navigation.title')}</h5>
        ...
        <div className="mt-8 border-t border-gray-700 pt-4 text-center">
          <p className="text-xs text-gray-500">
            ...
            />
            <span className="text-teal-400 font-semibold">{t('footer.builtWith.react')}</span>{" "}
            ...
            />{" "}
            <span className="text-orange-500 font-semibold">{t('footer.builtWith.java')}</span>
          </p>
        </div>
      </footer>
  );
