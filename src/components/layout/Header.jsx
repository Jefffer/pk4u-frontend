        ...
        <div className="flex items-center space-x-3">
          ...
          <img
            ...
            onError={(e) => {
              ...
              logoText.className = 'text-2xl font-bold text-sky-600 dark:text-sky-400';
              e.target.parentNode.insertBefore(logoText, e.target);
            }}
          />
          <h1 className="text-xl sm:text-2xl font-bold hidden sm:block">PK4U - Parking for You</h1>
        </div>
