...
const AboutPage = ({ userAlias, onLogout, currentTheme, toggleTheme }) => {
  ...
  <div className="relative z-10 flex flex-col items-center">
    ...
    <div className="mt-8 flex flex-wrap justify-center gap-4">
      ...
      <a
        ...
        className="px-6 py-3 rounded-lg bg-orange-500 text-white font-semibold shadow-lg hover:bg-orange-600/80 transition flex items-center gap-2"
      >
  ...
  <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
    <div className="md:w-1/2">
      ...
      />
      <LiaGlobeEuropeSolid
        className="absolute -top-8 -right-8 text-[7rem] text-teal-200 dark:text-teal-800 opacity-30 pointer-events-none hidden sm:block max-w-[40vw] max-h-[40vw]"
        style={{zIndex: 1}}
      />
    </div>
          </div>
  ...
  <div className="container mx-auto px-4 flex flex-col-reverse md:flex-row items-center gap-12">
    <div className="md:w-1/2 flex justify-center relative overflow-hidden">
      ...
      <img
        src="/pk4u-v2.png"
        alt={t("about.logoAlt")}
        className="absolute -bottom-8 -left-8 h-20 w-20 rounded-full bg-white/80 dark:bg-slate-900/80 p-2 shadow-lg border-2 border-teal-200 dark:border-teal-800 hidden sm:block"
        style={{zIndex: 1, maxWidth: "40vw", maxHeight: "40vw"}}
      />
    </div>
            <div className="md:w-1/2">
